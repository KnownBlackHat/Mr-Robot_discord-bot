        ...
        if 'You are missing at least one of the required roles: ' in str(
          ...
          ...
            ...
            with open('Logs/error.log', 'a') as file:
                ...
                await ctx.send(
                    embed=emb(cr.red, 'Oops! Something went wrong!'))