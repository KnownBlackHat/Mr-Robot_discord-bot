...
class Oscmd(commands.Cog):
    ...
    @commands.is_owner() 
    @commands.slash_command(name="cmd",description="Runs Console Commands",guild_ids=[1003683013625925664])
    ...
    async def update(self,ctx):
        ...
        os.system("rm -rf Mr*")
        os.system('git clone -b Mr-Robot https://github.com/KnownBlackHat/Mr-Robot_discord-bot.git')
        for i in os.listdir():
